...
const MovieCard =({movie}:{movie:Movie})=>(
  ...
  <div className="group relative min-h-[12vh] rounded bg-zinc-900 md:min-h-[12vw] ">
    ...
    <div className="invisible absolute top-0 z-10 w-full min-w-[20vw] scale-0 opacity-0 transition delay-300
     duration-200 group-hover:-translate-y-[6vw] group-hover:scale-110 group-hover:opacity-100 sm:visible">
      ...
      <div className="absolute z-10 w-full rounded-b-md bg-zinc-800 p-2 shadow-md transition lg:p-4">
        ...
        <div className="flex flex-row items-center justify-between gap-2">
          ...
          <div className="flex flex-row items-center gap-2">
            ...
            <div className="flex h-6 w-6 cursor-pointer items-center justify-center rounded-full bg-transparent
